...
const ExperienceSection: React.FC = () => {
  ...
  return (
    <section id="experience" className="space-section bg-slate-50 dark:bg-slate-900">
      <div className="container-custom">
        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute top-0 bottom-0 left-1/2 w-1 bg-gradient-to-b from-primary-300 via-primary-500 to-secondary-600 dark:from-primary-700 dark:via-primary-500 dark:to-secondary-700 rounded-full transform -translate-x-1/2"></div>
          {/* For mobile, a simpler line on the left */}
          <div className="md:hidden absolute top-0 bottom-0 left-4 w-1 bg-gradient-to-b from-primary-300 via-primary-500 to-secondary-600 dark:from-primary-700 dark:via-primary-500 dark:to-secondary-700 rounded-full"></div>
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-4 md:left-1/2 transform md:-translate-x-1/2 z-10">
        <div className="w-8 h-8 rounded-full bg-white dark:bg-slate-800 border-4 border-primary-500 dark:border-primary-400 flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
      ...
      <div className={`w-full md:w-5/12 mt-10 md:mt-0 ${isLeft ? 'md:pr-8' : 'md:pl-8'} ml-12 md:ml-0`}>
        <div className="card-hover">
          <div className="card-content">
            ...
            <div className="w-16 h-16 mr-5 overflow-hidden rounded-lg border border-slate-200 dark:border-slate-700 flex-shrink-0 shadow-sm bg-slate-50 dark:bg-slate-700 flex items-center justify-center">
              <img 
            ...
            <div className="flex-grow">
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">{experience.position}</h3>
              <h4 className="text-lg font-semibold text-primary-600 dark:text-primary-400">{experience.company}</h4>
          ...
          <div className="mt-6">
            ...
            >
              <span className="font-semibold text-slate-700 dark:text-slate-200"> {isExpanded ? 'Hide' : 'View'} Key Achievements</span>
              <svg
                className={`ml-2 h-5 w-5 text-slate-500 dark:text-slate-400 transform transition-transform duration-300 ${isExpanded ? 'rotate-180' : ''}`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
              ...
              <ul className="list-none pl-0 space-y-2 text-slate-600 dark:text-slate-300">
                {experience.achievements.map((achievement, i) => (
                  <li key={i} className="flex items-start">
                    <svg className="w-4 h-4 mr-2 mt-1 text-primary-500 dark:text-primary-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
          ...
          <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-700/50">
            <h5 className="text-sm font-semibold text-slate-500 dark:text-slate-400 mb-3">Technologies Used:</h5>
