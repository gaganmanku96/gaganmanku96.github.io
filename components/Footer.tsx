...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    { name: 'GitHub', href: 'https://github.com/gaganmanku96', icon: 'github' },
    { name: 'LinkedIn', href: 'https://linkedin.com/in/gaganmanku96', icon: 'linkedin' },
    { name: 'Twitter', href: 'https://twitter.com/gaganmanku96', icon: 'twitter' },
    { name: 'Medium', href: 'https://medium.com/@gaganmanku96', icon: 'medium' },
    { name: 'HuggingFace', href: 'https://huggingface.co/gaganmanku96', icon: 'huggingface' },
  ];
    ...
    <footer className="bg-light-bg dark:bg-dark-bg border-t border-gray-200 dark:border-gray-800">
      <div className="container-custom py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/case-studies" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Case Studies
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-800 text-center text-sm text-gray-600 dark:text-gray-400">
          <p>© {currentYear} Gagandeep Singh. All rights reserved.</p>
          <p className="mt-2">
...
function renderSocialIcon(name: string) {
  switch (name) {
    case 'github':
      return (
        <svg className="h-6 w-6" fill="#333" viewBox="0 0 24 24">
